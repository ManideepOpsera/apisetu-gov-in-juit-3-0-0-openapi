# Jaypee University Of Information Technology, Waknaghat (H. P.) MCP Server

This MCP (Model Content Protocol) server provides access to Jaypee University Of Information Technology, Waknaghat (H. P.) API functionality through HTTP, HTTPS, and STDIO transport modes.
